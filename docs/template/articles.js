export const getTemplateSidebar = () => [{
  text: '基本算法',
  children: [
    '',
    ...
    '/template/01.primary-algorithm/模板-悬线法.md',
  ],
}, {
  text: '初级数据结构',
  children: [
  ...
  children: [
    ...
    '/template/05.advanced-data-structure/模板-三维偏序.md',
  ],
}, {
  text: '动态规划',
  children: [
    ...
    '/template/06.dynamic-programming/模板-状态机DP.md',
  ...
  children: [
    ...
    '/template/07.graph-theory/模板-欧拉路与欧拉回路.md',
