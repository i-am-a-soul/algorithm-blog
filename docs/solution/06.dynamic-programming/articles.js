export const getDynamicProgrammingSidebar = () => [{
  text: '线性DP',
  children: [
    '/solution/06.dynamic-programming/6.1 线性DP/题解-杨老师的照相排列-线性DP.md',
    '/solution/06.dynamic-programming/6.1 线性DP/题解-最长公共上升子序列-线性DP.md',
    '/solution/06.dynamic-programming/6.1 线性DP/题解-分级-线性DP.md',
  ...
  text: '背包',
  children: [
    '/solution/06.dynamic-programming/6.2 背包/题解-潜水员-背包.md',
    ...
    '/solution/06.dynamic-programming/6.2 背包/题解-能量石-贪心+背包.md',
  ],
}, {
  text: '状态机DP',
  children: [
  ...
  text: '环形与后效性处理',
  children: [
    '/solution/06.dynamic-programming/6.6 环形与后效性处理/题解-休息时间-环形处理.md',
    '/solution/06.dynamic-programming/6.6 环形与后效性处理/题解-坏掉的机器人-后效性处理.md',
  ],
}, {
  text: '状态压缩DP',
  children: [
    '/solution/06.dynamic-programming/6.7 状态压缩DP/题解-最短Hamilton路径-状压DP.md',
    '/solution/06.dynamic-programming/6.7 状态压缩DP/题解-蒙德里安的梦想-状压DP.md',
    '/solution/06.dynamic-programming/6.7 状态压缩DP/题解-炮兵阵地-状压DP_解法一_.md',
    '/solution/06.dynamic-programming/6.7 状态压缩DP/题解-炮兵阵地-状压DP_解法二_.md',
  ],
}, {
  text: '倍增优化DP',
  children: [
    '/solution/06.dynamic-programming/6.8 倍增优化DP/题解-计算重复-倍增优化.md',
  ],
}, {
  text: '数据结构优化DP',
  children: [
    '/solution/06.dynamic-programming/6.9 数据结构优化DP/题解-清理班次-线段树优化.md',
    '/solution/06.dynamic-programming/6.9 数据结构优化DP/题解-清理班次2-线段树优化.md',
    '/solution/06.dynamic-programming/6.9 数据结构优化DP/题解-赤壁之战-平衡树优化.md',
  ],
}, {
  text: '单调队列优化DP',
  children: [
  ...
  text: '斜率优化',
  children: [
    '/solution/06.dynamic-programming/6.11 斜率优化/题解-任务安排1-费用提前计算.md',
    '/solution/06.dynamic-programming/6.11 斜率优化/题解-任务安排2-斜率优化.md',
    '/solution/06.dynamic-programming/6.11 斜率优化/题解-任务安排3-斜率优化.md',
    '/solution/06.dynamic-programming/6.11 斜率优化/题解-运输小猫-斜率优化.md',
  ],
}, {
  text: '四边形不等式',
  children: [
    '/solution/06.dynamic-programming/6.12 四边形不等式/题解-再探石子合并-四边形不等式优化.md',
  ],
}, {
  text: '计数DP',
  children: [
    '/solution/06.dynamic-programming/6.13 计数DP/题解-装饰围栏-计数DP.md',
    '/solution/06.dynamic-programming/6.13 计数DP/题解-低价购买-计数DP.md',
    '/solution/06.dynamic-programming/6.13 计数DP/题解-数的划分-计数DP.md',
  ],
}, {
  text: '数位统计DP',
  children: [
    ...
    '/solution/06.dynamic-programming/6.14 数位统计DP/题解-计数问题-数位DP.md',
    ...
    '/solution/06.dynamic-programming/6.14 数位统计DP/题解-数字游戏 II-数位DP.md',
    '/solution/06.dynamic-programming/6.14 数位统计DP/题解-Windy数-数位DP.md',
    '/solution/06.dynamic-programming/6.14 数位统计DP/题解-不要62-数位DP.md',
  ],
}];
